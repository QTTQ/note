...
__all__ = ('simple_cache', 'bubble_sort', 'insertion_sort', 'selection_sort',
           'merge_sort', 'quick_sort', 'shell_sort', 'heap_sort', 'to_pylist')
...
def merge_sort(seq=None):
    ...
    def merge(left_, right_):
        ...
        while left_ and right_:
            merged.append(left_.popleft()
                          if left_[0] < right_[0] else right_.popleft())
