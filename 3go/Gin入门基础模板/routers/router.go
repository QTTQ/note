...
import (
  ...
  . "BlogBaseOnGin/apis" //api部分
  . "BlogBaseOnGin/controllers" //constroller部分
 )
...
func InitRouter() *gin.Engine{
  ...
  router.POST("/home/PageData", GetDataList)//后台数据
  router.POST("/home/PageNextData", PageNextData)//后台数据

  //新增页面
  router.GET("/home/add", AddHtml)
  router.POST("/home/saveadd", AddPersonApi)//后台数据
  
   //编辑页面
   router.GET("/home/edit", EditHtml)
   router.POST("/home/saveedit", EditPersonApi)//后台数据

    //删除
    router.POST("/home/delete", DeletePersonApi)//后台数据
