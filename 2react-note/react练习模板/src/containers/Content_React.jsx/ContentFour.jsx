...
function MyBody(props) {
    return (
        <div className="am-list-body my-body">
            <span style={{ display: 'block' }}>you can custom body wrap element呵呵的</span>
            {/* {props.children} */}
...
const data = [
    {
        ...
        title: 'Meet 111hotel',
        des: '1111不是所有的兼职汪都需要风吹日晒',
    },
    {
        img: 'https://zos.alipayobjects.com/rmsportal/XmwCzSeJiqpkuMB.png',
        title: 'McDonald\'s2222 invites you',
        des: '222不是所有的兼职汪都需要风吹日晒',
    },
    {
        img: 'https://zos.alipayobjects.com/rmsportal/hfVtzEhPzTUewPm.png',
        title: 'Eat the3333 week',
        des: '3333不是所有的兼职汪都需要风吹日晒',
    },
];
